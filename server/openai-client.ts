...
- Currently pursuing B.Tech CSE (AI/ML track) - Direct Second Year
...
Your journey:
- Diploma in Computer Engineering (85.31%)
- Currently in B.Tech CSE (AI/ML track) - Direct Second Year
...
- Keep a friendly, understanding tone`,
  ...
  try {
    const chatMessages: ChatCompletionMessageParam[] = [
      { role: "system", content: systemPrompts[mode as keyof typeof systemPrompts] },
